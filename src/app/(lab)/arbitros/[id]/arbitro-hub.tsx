...
// ─── Static role list (hardcoded IDs matching the system) ───────────────────
...
function getRoleLabel(roleId: string | null, roles: RefereeRole[]): string {
  if (!roleId) return "—";
  const found = REFEREE_ROLES_STATIC.find(r => r.id === roleId)?.label
...
function SectionHeader({ label, count }: { label: string; count?: number }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16 }}>
      ...
      <div style={{
        flex: 1, height: 1,
        background: "linear-gradient(to right, rgba(191,242,5,0.25), transparent)",
      }} />
    </div>
  );
}
  ...
  return (
    ...
    >
      ...
      <div style={{ width: 140, flexShrink: 0 }}>
        <p style={{ fontFamily: "var(--font-mono)", fontSize: 11, fontWeight: 700, color: "var(--color-text-primary)", margin: 0 }}>
          {competitionLabel}
        </p>
        {match.phaseName && (
          <p style={{ fontFamily: "var(--font-mono)", fontSize: 9, color: "rgba(255,255,255,0.3)", margin: 0, marginTop: 1 }}>
            {match.phaseName}
          </p>
        )}
      </div>
      ...
      <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", gap: 12 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, justifyContent: "flex-end", flex: 1 }}>
          ...
          {match.teamA?.logo_url && (
            <img src={match.teamA.logo_url} alt="" style={{ width: 24, height: 24, objectFit: "contain" }} />
          )}
        </div>
        ...
        <div style={{
          ...
          {scoreReady ? (
            <>
              <span style={{ fontFamily: "var(--font-mono)", fontSize: 14, fontWeight: 800, color: "var(--color-text-primary)" }}>
                {match.scoreA}
              </span>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 8, flex: 1 }}>
          {match.teamB?.logo_url && (
            <img src={match.teamB.logo_url} alt="" style={{ width: 24, height: 24, objectFit: "contain" }} />
          )}
      ...
      <div style={{ width: 100, flexShrink: 0, textAlign: "right" }}>
        <span style={{
          ...
          backgroundColor: "rgba(191,242,5,0.08)", color: "#BFF205",
          border: "1px solid rgba(191,242,5,0.15)",
        }}>
          {roleLabel}
        </span>
      </div>
  ...
  return (
    <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: 16, alignItems: "start" }}>
      ...
      <div style={{
        ...
        backgroundColor: "var(--color-surface)", padding: 20,
      }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 14 }}>
          <div style={{ position: "relative" }}>
            <div style={{
              ...
              {displayPhoto ? (
                ...
                <span style={{ fontFamily: "var(--font-mono)", fontSize: 22, fontWeight: 700, color: "rgba(255,255,255,0.2)" }}>
          ...
          {pendingPhoto && (
            <p style={{ fontFamily: "var(--font-mono)", fontSize: 10, color: "rgba(255,255,255,0.3)", textAlign: "center" }}>
              {pendingPhoto.name}
            </p>
          )}
        </div>
    ...
    return (
      <div style={{
        ...
        <p style={{ fontFamily: "var(--font-mono)", fontSize: 11, color: "rgba(255,255,255,0.2)", marginTop: 6 }}>
          Este árbitro ainda não foi vinculado a nenhuma partida.
        </p>
      </div>
    );
  }
...
type Tab = "informacoes" | "jogos";

export default function ArbitroHub({ referee, matches, refereeRoles }: Props) {
    ...
    <div style={{ display: "flex", flexDirection: "column", minHeight: "100vh", backgroundColor: "var(--color-background)" }}>
      ...
      <div style={{
        ...
        <div style={{ padding: "20px 32px 0" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 16, marginBottom: 20 }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 4 }}>
                <span style={{ fontFamily: "var(--font-mono)", fontSize: 10, color: "#BFF205" }}>
                  {roleLabel}
                </span>
          ...
          <div style={{ display: "flex", gap: 0 }}>
            {(["informacoes", "jogos"] as Tab[]).map(tab => {
              const labels: Record<Tab, string> = { informacoes: "Informações", jogos: "Jogos" };
              ...
              return (
                ...
                >
                  ...
                  {tab === "jogos" && matches.length > 0 && (
                    <span style={{
                      marginLeft: 7, fontFamily: "var(--font-mono)", fontSize: 9,
                      padding: "2px 6px", borderRadius: 10,
                      backgroundColor: isActive ? "rgba(191,242,5,0.15)" : "rgba(255,255,255,0.06)",
                      color: isActive ? "#BFF205" : "rgba(255,255,255,0.2)",
                    }}>
                      {matches.length}
                    </span>
                  )}
      ...
      <div style={{ flex: 1, padding: "24px 32px" }}>
        {activeTab === "informacoes" && (
          <AbaInformacoes referee={referee} roles={refereeRoles} />
        )}
        {activeTab === "jogos" && (
          <AbaJogos matches={matches} roles={refereeRoles} />
        )}
      </div>
    </div>
  );
